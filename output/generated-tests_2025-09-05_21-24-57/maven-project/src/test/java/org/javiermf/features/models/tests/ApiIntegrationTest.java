...
public class ApiIntegrationTest {
    ...
    @Test
    @Ignore("API returns 500 instead of 404 for non-existent feature")
    ...
    @Test
    @Ignore("API returns 200 instead of 404 for non-existent configuration")
    ...
    @Test
    @Ignore("API returns 204 instead of 404 for non-existent configuration")
    ...
    @Test
    @Ignore("API returns 500 instead of 404 for non-existent configuration")
    ...
    @Test
    @Ignore("API returns 500 instead of 404 for non-existent configuration features")
    ...
    @Test
    @Ignore("API returns 500 instead of 404 for non-existent configuration feature")
    ...
    @Test
    @Ignore("API returns 500 instead of 404 for non-existent constraint")
    ...
    @Test
    @Ignore("API returns 404 instead of 200 for root source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 200 for configuration source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 201 for configuration source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 204 for configuration source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 201 for feature source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 204 for feature source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 200 for feature source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 201 for requires source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 201 for excludes source code")
    ...
    @Test
    @Ignore("API returns 404 instead of 204 for constraint source code")
